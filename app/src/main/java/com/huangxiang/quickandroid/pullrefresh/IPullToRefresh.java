 ...
 *******************************************************************************/
package com.huangxiang.quickandroid.pullrefresh;
...
public interface IPullToRefresh<T extends View> {
	...
	/**
	 * Set the current mode of Pull-to-Refresh that this view will use.
	 * 
	 * @param mode - current Mode to set the View to
	 */
